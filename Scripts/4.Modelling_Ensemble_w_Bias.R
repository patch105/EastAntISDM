...
PO_East_Ant_Veg_No_Bunger_sf <- st_read(here("Data/Biological_records", "PO_Veg_East_Ant_No_Bunger.shp"))
PO_East_Ant_Veg_No_Vestfold_sf <- st_read(here("Data/Biological_records", "PO_Veg_East_Ant_No_Vestfold.shp"))
...
map(PO_datasets, function(dataset){
  ...
  dir.create(file.path(outpath, "RF_outputs", dataset), showWarnings = F, recursive = TRUE)
