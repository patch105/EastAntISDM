...
m.int.occ.VH$preds.INT.Vestfold <- predict(m.int.occ.VH, 
                                             covars = covs,
                                             habitatArea = "sampAreaPA_Vestfold",
                                             S = 500,
                                             intercept.terms = "PA_Intercept",
...
m.int.occ.VH$preds.INT.Bunger <- predict(m.int.occ.VH,
                                           covars = covs,
                                           habitatArea = "sampAreaPA_Bunger",
                                           S = 500,
                                           intercept.terms = "PA_Intercept",
...
m.int.occ.VH$preds.prob.Vestfold <- predict(m.int.occ.VH, 
                                              covars = covs,
                                              habitatArea = "sampAreaPA_Vestfold",
                                              S = 500,
                                              intercept.terms = "PA_Intercept",
...
m.int.occ.VH$preds.prob.Bunger <- predict(m.int.occ.VH,
                                            covars = covs,
                                            habitatArea = "sampAreaPA_Bunger",
                                            S = 500,
                                            intercept.terms = "PA_Intercept",
...
m.int.occ.VH.bias$preds.INT.Vestfold <- predict(m.int.occ.VH.bias, 
                                                  covars = covs,
                                                  habitatArea = "sampAreaPA_Vestfold",
                                                  S = 500,
                                                  intercept.terms = "PA_Intercept",
...
m.int.occ.VH.bias$preds.INT.Bunger <- predict(m.int.occ.VH.bias,
                                                  covars = covs,
                                                  habitatArea = "sampAreaPA_Bunger",
                                                  S = 500,
                                                  intercept.terms = "PA_Intercept",
...
m.int.occ.VH.bias$preds.prob.Vestfold <- predict(m.int.occ.VH.bias, 
                                                   covars = covs,
                                                   habitatArea = "sampAreaPA_Vestfold",
                                                   S = 500,
                                                   intercept.terms = "PA_Intercept",
...
m.int.occ.VH.bias$preds.prob.Bunger <- predict(m.int.occ.VH.bias,
                                                   covars = covs,
                                                   habitatArea = "sampAreaPA_Bunger",
                                                   S = 500,
                                                   intercept.terms = "PA_Intercept",
...
m.int.Plantarctica.VH$preds.INT.Vestfold <- predict(m.int.Plantarctica.VH, 
                                                       covars = covs,
                                                       habitatArea = "sampAreaPA_Vestfold",
                                                       S = 500,
                                                       intercept.terms = "PA_Intercept",
...
m.int.Plantarctica.VH$preds.INT.Bunger <- predict(m.int.Plantarctica.VH,
                                                       covars = covs,
                                                       habitatArea = "sampAreaPA_Bunger",
                                                       S = 500,
                                                       intercept.terms = "PA_Intercept",
...
m.int.Plantarctica.VH$preds.prob.Vestfold <- predict(m.int.Plantarctica.VH, 
                                                          covars = covs,
                                                          habitatArea = "sampAreaPA_Vestfold",
                                                          S = 500,
                                                          intercept.terms = "PA_Intercept",
...
m.int.Plantarctica.VH$preds.prob.Bunger <- predict(m.int.Plantarctica.VH,
                                                          covars = covs,
                                                          habitatArea = "sampAreaPA_Bunger",
                                                          S = 500,
                                                          intercept.terms = "PA_Intercept",
...
m.int.occ.Plantarctica.VH$preds.INT.Vestfold <- predict(m.int.occ.Plantarctica.VH, 
                                                             covars = covs,
                                                             habitatArea = "sampAreaPA_Vestfold",
                                                             S = 500,
                                                             intercept.terms = "PA_Intercept",
...
m.int.occ.Plantarctica.VH$preds.INT.Bunger <- predict(m.int.occ.Plantarctica.VH,
                                                             covars = covs,
                                                             habitatArea = "sampAreaPA_Bunger",
                                                             S = 500,
                                                             intercept.terms = "PA_Intercept",
...
m.int.occ.Plantarctica.VH$preds.prob.Vestfold <- predict(m.int.occ.Plantarctica.VH, 
                                                                covars = covs,
                                                                habitatArea = "sampAreaPA_Vestfold",
                                                                S = 500,
                                                                intercept.terms = "PA_Intercept",
...
m.int.occ.Plantarctica.VH$preds.prob.Bunger <- predict(m.int.occ.Plantarctica.VH,
                                                                covars = covs,
                                                                habitatArea = "sampAreaPA_Bunger",
                                                                S = 500,
                                                                intercept.terms = "PA_Intercept",
