...
############################################
# Evaluate the predictions on VESTFOLD PA dataset ----------------
############################################
...
############################################
# Evaluate the presence-only predictions on BUNGER PA dataset ----------------
############################################
...
write.csv(eval_df, file = paste0(outpath, "/RISDM_PO_models_BUNGER_eval_df.csv"))


############################################
# Evaluate the MODEL FIT (PA & INTEGRATED) on BUNGER PA dataset  ---------
############################################
